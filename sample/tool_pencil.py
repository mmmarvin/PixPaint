...
class ExamplePencilTool(pixpaint.PaintTool):
	def __init__(self):
		super().__init__()
...
pixpaint.getPaintToolRegistrar().registerTool("Example Pencil Tool", "res/icons/brush_tool.png", "examplepenciltool", "", ExamplePencilTool())
